...
public:
  ...
  inline void setCandidateName(const char *newName) {
    strcpy(candidateName, newName);
  }
  inline void setCandidatePost(const char *newPost) {
    strcpy(candidatePost, newPost);
  }
